...
import { signIn, signInWithDiscord } from "../actions";
...
export default function LoginPage() {
  ...
  async function handleDiscordLogin() {
    ...
    await signInWithDiscord(redirect);
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,oklch(0.20_0.12_290),transparent_50%)]" />
